...
Runtime: 96 ms, faster than 37.46% of C++ online submissions for Maximum Units on a Truck.
Memory Usage: 17 MB, less than 40.06% of C++ online submissions for Maximum Units on a Truck.
