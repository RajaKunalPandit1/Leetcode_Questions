...
Runtime: 6 ms, faster than 26.57% of C++ online submissions for Evaluate Division.
Memory Usage: 8.2 MB, less than 89.56% of C++ online submissions for Evaluate Division.
