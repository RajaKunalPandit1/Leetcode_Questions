...
Runtime: 88 ms, faster than 35.13% of C++ online submissions for Pacific Atlantic Water Flow.
Memory Usage: 19 MB, less than 53.05% of C++ online submissions for Pacific Atlantic Water Flow.
