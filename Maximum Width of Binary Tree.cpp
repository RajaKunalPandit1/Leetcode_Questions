...
Runtime: 12 ms, faster than 60.60% of C++ online submissions for Maximum Width of Binary Tree.
Memory Usage: 17.4 MB, less than 21.15% of C++ online submissions for Maximum Width of Binary Tree.
