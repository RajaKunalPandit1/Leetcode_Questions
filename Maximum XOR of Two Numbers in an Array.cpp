...
Runtime: 789 ms, faster than 20.98% of C++ online submissions for Maximum XOR of Two Numbers in an Array.
Memory Usage: 65.2 MB, less than 83.21% of C++ online submissions for Maximum XOR of Two Numbers in an Array.
