...
Runtime: 7 ms, faster than 19.25% of C++ online submissions for String to Integer (atoi).
Memory Usage: 7.1 MB, less than 14.31% of C++ online submissions for String to Integer (atoi).
